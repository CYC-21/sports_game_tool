...
function renderAbout() {
  ...
  blocks.push(
    '<header class="static-header"><a href="#/" class="back">' +
      ...
      '<p>你可以透過「投稿」的方式新增賽事、景點等等資料。我也將程式碼放在 <a href="https://github.com/CYC-21/sports_game_tool">GitHub</a> 上並使用 <a href="https://choosealicense.com/licenses/gpl-3.0/">GPL-3.0</a> 授權，歡迎你取用，並改成更好用的樣子。</p>' +
